...
const gallery = [
  {
    label: "CNC Shop Floor",
    icon: Factory,
    ratio: "photo" as const,
    src: "/images/facility/cnc-shop-floor.jpg",
  },
  {
    label: "Turning Cell",
    icon: Cog,
    ratio: "photo" as const,
    src: "/images/facility/turning-cell.jpg",
  },
  {
    label: "Inspection Lab",
    icon: ScanLine,
    ratio: "photo" as const,
    src: "/images/facility/inspection-lab.jpg",
  },
];
